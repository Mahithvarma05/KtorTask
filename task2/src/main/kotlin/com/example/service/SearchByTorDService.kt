...
class SearchByTorDService {
        ...
        val result = transaction {
            (ProductTable innerJoin ImagesTable)
                ...
                .select { Op.build {
                    (ProductTable.title like "%${query}%") or (ProductTable.description like "%${query}%")
                } }.map {
                    ...
                    ProductResponce(id,title,description,price,discountPercentage,rating,stock,brand,category,thumbnail,images)
